...
shared_examples "signing and verification" do |enc_class, curve_name|
  ...
  it "can use DER-encoded sign data and verify signatures" do
    data = "some data to sign"
    group = OpenSSL::PKey::EC::Group.new(curve_name) 
    private_key = OpenSSL::PKey::EC.new(group).generate_key
  ...
  it "can use PEM-encoded sign data and verify signatures" do
    data = "some data to sign"
    group = OpenSSL::PKey::EC::Group.new(curve_name) 
    private_key = OpenSSL::PKey::EC.new(group).generate_key
...
describe Sandal::Sig::ES256 do
  include_examples "signing and verification", Sandal::Sig::ES256, "prime256v1"
  ...
  context "#verify?" do
    ...
    it "can verify the signature in JWS draft-11 appendix 3" do
...
describe Sandal::Sig::ES384 do
  include_examples "signing and verification", Sandal::Sig::ES384, "secp384r1"
...
describe Sandal::Sig::ES512 do
  include_examples "signing and verification", Sandal::Sig::ES512, "secp521r1"
  ...
  context "#verify?" do
    ...
    it "can verify the signature in JWS draft-11 appendix 4" do

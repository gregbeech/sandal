...
describe Sandal::Sig::ES do
  ...
  context "#encode_jws_signature" do
    ...
    it "can encode the signature in JWS draft-11 appendix 3" do
      ...
      base64_signature = Sandal::Base64.encode(signature)
...
describe Sandal::Sig::ES256 do
  ...
  context "#valid?" do
    ...
    it "can validate the signature in JWS draft-11 appendix 3" do
      ...
      signature = Sandal::Base64.decode("DtEhU3ljbEg8L38VWAfUAqOyKAM6-Xx-F4GawxaepmXFCgfTjDxw5djxLa8ISlSApmWQxfKTUJqPP3-Kg6NU1Q")
...
describe Sandal::Sig::ES512 do
  ...
  context "#validate?" do
    ...
    it "can validate the signature in JWS draft-11 appendix 4" do
      ...
      signature = Sandal::Base64.decode("AdwMgeerwtHoh-l192l60hp9wAHZFVJbLfD_UxMi70cwnZOYaRI1bKPWROc-mZZqwqT2SI-KGDKB34XO0aw_7XdtAG8GaSwFKdCAPZgoXD2YBJZCPEX3xKpRwcdOO8KpEHwJjyqOgzDO7iKvU8vcnwNrmxYbSW9ERBXukOXolLzeO_Jn")

...
describe Sandal::Sig::HS256 do
  include_examples "signing and verification", Sandal::Sig::HS256

  it "can verify the signature from JWS dratf-11 appendix 1" do
...
describe Sandal::Sig::HS384 do
  include_examples "signing and verification", Sandal::Sig::HS384
end

describe Sandal::Sig::HS512 do
  include_examples "signing and verification", Sandal::Sig::HS512
end
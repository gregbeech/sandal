...
describe Sandal::Enc::A128CBC_HS256 do
  ...
  context 'using the RSA key from JWE section A.2' do
    ...
    # exclude these tests from jruby, as it doesn't allow the rsa.d (private key) parameter to be modified directly
